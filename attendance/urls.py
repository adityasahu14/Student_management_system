...
urlpatterns = [
    ...
    path('dashboard/teacher/queries/', views.TeacherQueryListView.as_view(), name='teacher_queries'),
    ...
    path('dashboard/teacher/student/add/', views.TeacherStudentCreateView.as_view(), name='teacher_student_add'),
    path('dashboard/student/', views.StudentDashboardView.as_view(), name='student_dashboard'),
    path('dashboard/student/query/submit/', views.StudentQuerySubmitView.as_view(), name='student_query_submit'),
]
